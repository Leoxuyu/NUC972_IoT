...
/*---------------------------------------------------------------------------------------------------------*/
#define NUC_DATA_BITS_5     (0) /*!< UA_LCR setting to set UART word length to 5 bits */
#define NUC_DATA_BITS_6     (1) /*!< UA_LCR setting to set UART word length to 6 bits */
#define NUC_DATA_BITS_7     (2) /*!< UA_LCR setting to set UART word length to 7 bits */
#define NUC_DATA_BITS_8     (3) /*!< UA_LCR setting to set UART word length to 8 bits */

#define NUC_PARITY_NONE    (0x0 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as no parity   */
#define NUC_PARITY_ODD     (0x1 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as odd parity  */
#define NUC_PARITY_EVEN    (0x3 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as even parity */
#define NUC_PARITY_STICK    (0x8 << UART_LCR_PBE_Pos) /*!< UA_LCR setting to set UART as stick parity */

#define NUC_STOP_BITS_1     (0x0 << UART_LCR_NSB_Pos) /*!< UA_LCR setting for one stop bit  */
#define NUC_STOP_BITS_1_5   (0x1 << UART_LCR_NSB_Pos) /*!< UA_LCR setting for 1.5 stop bit when 5-bit word length  */
#define NUC_STOP_BITS_2     (0x1 << UART_LCR_NSB_Pos) /*!< UA_LCR setting for two stop bit when 6, 7, 8-bit word length */
